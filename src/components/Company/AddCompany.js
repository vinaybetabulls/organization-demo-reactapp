...
const AddCompany = () => {
  ...
  const { response: createCmp, isAuth, error, isLoading, handleChange, handleSubmit } = useFetch({
      ...
      <div className={classes.wrapper}>
        <form className={classes.root} noValidate autoComplete="off" onSubmit={handleSubmit}>
          ...
          <Grid item xs={12} sm={3}>
            <Button type="submit" fullWidth variant="contained" color="primary" className={classes.button} > Add </Button>
          </Grid>
        </form>
      </div>
